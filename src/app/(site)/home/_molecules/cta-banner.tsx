...
const content = {
  default: {
    ...
    desc: "Thousands of Nigerian students and corps members found their placements on I-TAPP. Sign up in minutes — no CV printing, no cold emails, no walk-ins.",
    cta1: { label: "Find my SIWES placement", href: "/signup", icon: <GraduationCap className="w-4 h-4" /> },
    cta2: { label: "Find my PPA", href: "/signup?role=corps", icon: <Shield className="w-4 h-4" /> },
    cta3: { label: "I'm a company", href: "/signup?role=company", icon: <Building2 className="w-4 h-4" /> },
  },
  student: {
    eyebrow: "Free to get started",
    title: "Stop cold-emailing.\nStart getting placed.",
    desc: "Thousands of Nigerian students found their SIWES placement on I-TAPP. Sign up in minutes — no CV printing, no walk-ins.",
    cta1: { label: "Create free account", href: "/signup", icon: <Sparkles className="w-4 h-4" /> },
  ...
  corps: {
    ...
    cta1: { label: "Find my PPA now", href: "/signup?role=corps", icon: <Shield className="w-4 h-4" /> },
  ...
  company: {
    ...
    cta1: { label: "List opportunities", href: "/signup?role=company", icon: <Building2 className="w-4 h-4" /> },
